export const SMTP2GO_VERIFIED_SENDER_DOMAIN = "products.signimus.com";
export const DEFAULT_SMTP2GO_SENDER = `support@${SMTP2GO_VERIFIED_SENDER_DOMAIN}`;
export const SMTP2GO_SENDER_DOMAIN_ERROR =
  "The sender domain is not verified in SMTP2GO. Please use an email address from products.signimus.com or verify the desired domain in SMTP2GO.";
